...
public class Methods {
	 ...
	 */
	public static int[] filledArray(int N, int value) {
		int[] values = new int[N]; // FIXME: Create an array of the appropriate size
		// TODO: Finish this method
		for (int i=0; i<values.length; i++ ) {
			values[i]=value;
		}
	...
	/**
	 * This method returns the mean of the values in the provided array.
	 * @param values - the values going into the array
	...
	public static double arrayMean(int[] values) {
		...
		double mean = (double)x/values.length;
